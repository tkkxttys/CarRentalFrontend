...
export default function CarPanel() {
    ...
    return(
        <div>
            ...
            <input type="text" placeholder="Plaese fill" className="block text-gray-900 text-sm rounded-lg p-2 m-2 bg-purple-50 ring-1 ring-inset ring-purple-400
